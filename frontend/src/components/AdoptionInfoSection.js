  ...
  return (
    <div className="adoption-info-section">
      <div className="adoption-info-card">
        ...
        <a href="https://www.petfinder.com/adopt-or-get-involved/adopting-pets/about/" className="learn-more-link">LEARN MORE</a>
      </div>
      <div className="adoption-info-card">
        <h3>FAQs</h3>
        <p>Get answers to questions you haven't thought of.</p>
        <a href="https://www.petfinder.com/adopt-or-get-involved/adopting-pets/how-to/pet-adoption-faqs/" className="learn-more-link">LEARN MORE</a>
      </div>
      <div className="adoption-info-card">
        <h3>Planning to foster a pet?</h3>
        <p>Checklist for New Adopters</p>
        <p>Help make the transition as smooth as possible.</p>
        <a href="https://www.petfinder.com/adopt-or-get-involved/" className="learn-more-link">LEARN MORE</a>
      </div>
    </div>
  );
}
