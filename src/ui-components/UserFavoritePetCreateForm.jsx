...
import { createUserFavoritePet } from "../graphql/mutations";
export default function UserFavoritePetCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createUserFavoritePet.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "UserFavoritePetCreateForm")}
      {...rest}
    >
      <TextField
        label="User id"
