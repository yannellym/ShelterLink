...
# https://nominatim.org/ for geo location
# Google: places API, Maps JavaScript  API, and Geocoding API 
# https://fontawesome.com/ for icons
# react hooks and custom hooks
# SNS, AMPLIFY, CLOUDFORMATION, COGNITO, S3, lambda, api gateway, cloudwatch, IAM, cloudfront, Lambda@Edge,aws pinpoint, appsync
# Google Auth
# JSON
# CI/CD - github
# axios
