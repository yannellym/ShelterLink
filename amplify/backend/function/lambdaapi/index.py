...
def lambda_handler(event, context):
    try:
        ...
        # Define the base Petfinder API URL for animals
        petfinder_api_url = 'https://api.petfinder.com/v2/animals'

        # Add all parameters to the API URL using the 'params' parameter of requests.get
        headers = {
            'Authorization': f'Bearer {get_petfinder_access_token()}',
            'x-api-key': os.environ['PETFINDER_API_KEY'],
        }

        # Make request to Petfinder API for animals
